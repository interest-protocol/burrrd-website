...
export { default as CircleArrowLeftSVG } from './circle-arrow-left';
export { default as CircleArrowRightSVG } from './circle-arrow-right';
...
export { default as DexScreenerSVG } from './dex-screener';
